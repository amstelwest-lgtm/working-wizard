...
function Index() {
  ...
  // Dual-role founders (practice + client) keep /app unless they just signed
  // in through the accountant door (force flag). Accountants impersonating a
  // client (actingClientId) also stay.
  useEffect(() => {
    if (!user) return;
    const acting =
      actingClientId ||
