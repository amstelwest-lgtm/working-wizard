  ...
  return (
    ...
    >
      ...
      <ul className="mk-list">
        <li>
          <strong>No company names.</strong> The model does not get the trading name, the registered
        ...
        <li>
          <strong>
            <MarketCopy
              za="VAT and account numbers are stripped"
              us="EIN / tax IDs and account numbers are stripped"
            />
          </strong>{" "}
          from the question and the context before anything is sent.
        </li>
      </ul>
      <p>
      ...
      <p>
        Where AI drafts an advisory note for an accountant, a human reads it and signs it before a
        client ever sees it. The model does not send mail to your clients. It does not file anything
        with <MarketCopy za="SARS" us="the IRS or a state department of revenue" />. It does not
        replace the accountant you already have.
      </p>

      <h2>You can use Milōn without talking to it</h2>
      <p>
        The score, the waterfall, the forecast, and the action plan do not require you to open the
        assistant. Asking a question is optional. Uploading figures into your own workspace is how
        the product gets its arithmetic — that store is covered by the{" "}
        <a href="/privacy">privacy notice</a>, under row-level security, visible only to you and the
        people you invite.
      </p>
      ...
      <div className="mk-note">
        If a sentence on this page turns out to be wrong, tell us and we will fix the page. We would
        rather correct it than defend it. Related: <a href="/privacy">Privacy</a> ·{" "}
