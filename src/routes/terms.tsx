...
function TermsPage() {
  return (
    ...
    >
      ...
      <h2>The service</h2>
      <p>
        Milōn is a financial-health workspace: a score, a forecast, and a ranked list of what to do
      ...
      <p>
        ...
        score is arithmetic on those figures — it is exactly as good as what you give it. Where the
        platform is guessing or a number is missing, it says so.
      </p>
      ...
      <ul className="mk-list">
        ...
        <li>
          Do not try to break access rules, scrape other workspaces, or use the product to harm
          someone.
        </li>
        <li>
          Do not present Milōn output as a signed-off audit,{" "}
          <MarketCopy za="a SARS filing," us="an IRS or state tax filing," /> or independent advice.
        </li>
      </ul>
      ...
      <p>
        ...
        promise it will never break. If we have to withdraw a feature, we will say so in the product
        rather than quietly deleting it under you.
      </p>

      <h2>Liability</h2>
      <p>
        Milōn is a decision-support tool. We are not liable for business decisions you take from a
        score, a forecast, or an AI draft, or for losses that follow from figures you uploaded.
      ...
      <p>
        ...
        page is the date that applies. Material changes will be obvious on this page, not hidden in
        a changelog.
      </p>
