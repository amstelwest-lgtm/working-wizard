...
function Sphere({
  ...
  return (
    <button
      ...
      className="group relative flex shrink-0 select-none flex-col items-center justify-center rounded-full outline-none transition-transform duration-500 ease-out focus-visible:ring-2 focus-visible:ring-amber-400/60 enabled:cursor-pointer enabled:active:scale-95"
      style={{
        width: size,
        height: size,
