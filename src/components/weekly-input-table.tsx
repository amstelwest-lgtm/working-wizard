...
import {
  PREMIUM_INPUT_CLS,
  PremiumSectionCard,
} from "@/components/premium-section-card";
                    ...
                    >
                      <div className="relative inline-flex items-center">
                        ...
                        <input
                          ...
                          className={`${PREMIUM_INPUT_CLS} w-24 rounded-md py-1.5 pl-5 pr-2 text-right text-xs font-semibold focus:border-[#d4a550] focus:outline-none [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none`}
                        />
                      </div>
                    </td>
                  );
